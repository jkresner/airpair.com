...
var mg = {
  ...
  'devops': {
    ...
    suggested: [
      ...
      exp('https://www.airpair.com/adm/experts/55013180b2620c0c009bb3a4', 80,'Amine Mouafik','amine@mouafik.fr'),
  ...
  'ios': {
    ...
    suggested: [
      ...
      exp('53d2cb524e3fbd0200510790',110,'Jason Katzer','json@katzr.com'),
  ...
  'node.js': {
    ...
    suggested: [
      ...
      exp('533afde08ae986020000000f', 80,'Abraham Polishchuk','apolishc@gmail.com'),
      exp('55013180b2620c0c009bb3a4', 80,'Amine Mouafik','amine@mouafik.fr'),
  ...
  'ruby-on-rails': {
    ...
    suggested: [
      ...
      exp('522e4003a949270200000022', 80,'Daniel Davison','sircapsalot@gmail.com'),
      exp('52e142ef6efc05020000000c', 80,'Randall Bennett','randall@vidpresso.com'),
      exp('549f9d443a0ad90200e7a72e', 80,'Brandon J McKay','themckaystudios@gmail.com'),
      // exp('',80 ,'',''),
      // exp('',80 ,'',''),
