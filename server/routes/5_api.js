module.exports = function(app, mw) {
  ...
  app.use('/v1/api/*', [mw.$.noBot, mw.$.session, mw.$.cachedTags])
  ...
  //   .put('/users/me/bookmarks/:type/:id', mw.$.setAnonSessionData, API.Users.toggleBookmark)
    ...
    .get('/requests/:id/book/:expert', API.Requests.getRequestForBookingExpert)
  ...
  //   .get('/experts/search/:id', API.Experts.search)
    ...
    .use([mw.$.cachedSlackUsers,mw.$.inflateMe])
