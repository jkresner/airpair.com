...
module.exports = function(app) {
  ...
  return express.Router()
    ...
    .get('/heroku-151208-node.js',
       trackAdClick('https://signup.heroku.com/nodese?c=70130000000NYVEAA4&utm_campaign=Display%20-Endemic%20-Airpair%20-Node%20-%20Signup&utm_medium=display&utm_source=airpair&utm_term=node&utm_content=signup'),
        (req, res, cb) => res.redirect(req.ad.url) )

    .get('/heroku-151208-php',
       trackAdClick('https://signup.heroku.com/php?c=70130000000NYVFAA4&utm_campaign=Display%20-%20Endemic%20-Airpair%20-%20PHP%20-%20Signup&utm_medium=display&utm_source=airpair&utm_term=php&utm_content=signup'),
        (req, res, cb) => res.redirect(req.ad.url) )

    .get('/heroku-151208-java',
       trackAdClick('https://signup.heroku.com/java?c=70130000000NYVGAA4&utm_campaign=Display%20-%20Endemic%20-Airpair%20-Java%20-%20Signup&utm_medium=display&utm_source=airpair&utm_term=java&utm_content=signup'),
        (req, res, cb) => res.redirect(req.ad.url) )
