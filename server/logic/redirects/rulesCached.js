let concat = all => all.concat(
  ...
  [ // 418 Bait
   ...
   .map( url => assign({url},{type:'bait'}) ),


  [ // 301 redirect
    { type:'301', url: '/posts/new', to: '/author/new' },
    { type:'301', url: '/posts/me', to: '/author' },
    ...
    { type:'301', url: '/static/img/css/tags/angularjs-og.png', to: 'https://static.airpair.com/img/software/angularjs.png' },
    ...
    { type:'301', url: '/code-mentoring', to: '/' },
    ...
    { type:'301', url: '/angularjs2', to: '/angularjs' },
    ...
    { type:'301', url: '/ruby-on-rails-problem-solving*', to: '/ruby-on-rails' },
    ...
    { type:'301', url: '/pubnub/posts/pubnub-support-and-api-integration-help', to: '/pubnub' },
    { type:'301', url: '/sendgrid/posts/sendgrid-salesforce-apex-library-1',  to: '/email' },
    { type:'301', url: '/evernote/posts/evernote-support-api-integration-help', to: '/evernote' },
    ...
    { type:'301', url: '/python/python-expert-alexandre-gravier', to: '/python/machine-learning-expert-alexandre-gravier' },
    { type:'301', url: '/machine-learning/posts/machine-learning-expert-alexandre-gravier-1', to: '/python/machine-learning-expert-alexandre-gravier' },
    ...
    { type:'301', url: '*airconf*',  to: '/software-experts' },
    { type:'301', url: '/((ruby)|(ruby-on-rails/posts))/ruby-problem-solving-for-sendwith*',  to: '/ruby' },
    { type:'301', url: '/((tag/screenhero)|(pair-programmers/post))', to: '/software-experts' },
    ...
    { type:'301', url: '*((ryan-schmukler)|(tim-caswell)|(philip-thomas))*', to: '/node.js' }, //|(peter-lyon)
  ...
  [ // 302 redirect
    { type:'302', url: '/find-an-expert', to: '/software-experts' },
    { type:'302', url: '/hire-developers', to: '/' },
    { type:'302', url: '/hire-software-developers', to: '/software-experts' },
    { type:'302', url: '/meet-experts', to: '/software-experts' },
    { type:'302', url: '/pair-programming', to: '/' },
    ...
    { type:'302', url: '/me/brianmhunt', to: '/knockout.js' },
    { type:'302', url: '/me/ronlichty', to: '/agile' },
  ...
  [ // 301 rewrite
    ...
    { url: '&quot;$', to: '' },
    { url: '\\.\\.\\.', to: '' },
    { url: '^/posts/edit', to: '/author/editor' },
    { url: '^/posts/fork', to: '/author/fork' },
    { url: '/sqlserver$', to: '/sql-server' },
    { url: '/posts/tag/angularjs', to: '/angularjs/posts' },
    { url: '/posts/tag/node', to: '/node.js' },
    { url: '/posts/tag/', to: '/' },
    { url: '/tags/search/', to: '/tags/search?q=' },
    { url: '^((/i.stack.)|(/i.)|(/))imgur.com/*', to: 'https://i.imgur.com/' },
    { url: '/images/icons/', to: 'https://static.airpair.com/img/icons/' },
    { url: '/static/img/icons/', to: 'https://static.airpair.com/img/icons/' },
    { url: '/img/software/',  to: 'https://static.airpair.com/img/software/' },
  ]
   .map(rule => assign(rule,{type:'rewrite'}) )
...
module.exports = (DAL, Data, DRY) => ({
  ...
  exec(cb) {
    let r = {}
    for (let type of honey.model.Enum.REDIRECT.TYPE)
      r[type] = []

    if (!honey.cfg('routes.rules')) return cb(null, r)

    DAL.Redirect.getAll({ sort: { to: -1 }}, (e, all) => {
      if (e) return cb(e)

      // Collect rules by type
      for (let {type,url,to} of concat(all)) {
        if (/410|501|ban|bait/.test(type))
          r[type].push(url)
        else if (/rewrite|301|302/.test(type))
          // r[type].push(assign({ url, to })
          r[type].push(assign({ url }, to === undefined ? {} : { to: `${to}` }))
      }

      // console.log('rulesCached[301]', r["301"].map(({url,to})=>`${url} ${to.green}`).join('\n'))
      cb(null, r)
    })
  }
