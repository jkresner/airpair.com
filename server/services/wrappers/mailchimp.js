...
var APlists = [
 ...
 { id: '89214a2507',
   ...
   // date_created: '2014-08-14 15:28:32',
 ...
 { id: '69de3eea5d',
   ...
   // date_created: '2015-03-18 18:30:39',
 ...
 { id: 'f905e62324',
   ...
   // date_created: '2015-03-17 00:57:59',
...
var wrapper = {
  ...
  lists(cb) {
    api.call('lists', 'list', {}, function (e, r) {
      $log('back from MailChimpAPI.lists', e, r)
      if (e) cb(e)
      else
        cb(null,r)
    })
  ...
  subscribe(listName, email, merge_vars, email_type, double_optin, send_welcome, cb) {
    ...
    api.call('lists', 'subscribe', { id, email, merge_vars, email_type, double_optin, send_welcome }, (e, r) => {
      // $log('back from MailChimpAPI.subscribe', e, r)
      if (e) cb(e)
      else
        cb(null,r)
    })
  ...
  unsubscribe(listName, email, cb) {
    ...
    api.call('lists', 'unsubscribe', { id, email }, (e, r) => {
      // $log('back from MailChimpAPI.unsubscribe', e, r)
      if (e) cb(e)
      else
        cb(null,r)
    })
