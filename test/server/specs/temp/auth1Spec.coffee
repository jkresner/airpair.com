...
module.exports = ->
  ...
  describe "Signup", ->
    it 'New github sign can return to old page', itDone ->

  describe "Login", ->
    it 'Migrated all accounts', itDone ->
      # email && name to top


    it 'Merge all duplicate accounts', itDone ->
    it 'Existing github sign can return to old page', itDone ->
