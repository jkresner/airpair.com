module.exports = {
  ...
  byrn: {
    ...
    "brief" : "I love pair programming. I've been using it for a few years to learn and teach software development and architecture. In fact, I pair remotely EVERY DAY with a team of 15 remote software developers. I think the idea of AirPairing is really cool because it pairs people like me up with people like you! Contact me. Maybe I can give you a hand!",
    "gmail" : "byron@acklenavenue.com",
    "rate" : 230,
    "tags" : [
        { "_id" : ObjectId("514825fa2a26ea0200000022"), "sort" : 0 },
        { "_id" : ObjectId("514825fa2a26ea020000000e"), "sort" : 1 },
        { "_id" : ObjectId("514825fa2a26ea020000002a"), "sort" : 2 },
        { "_id" : ObjectId("514825fa2a26ea020000001f"), "sort" : 3 },
        { "_id" : ObjectId("514825fa2a26ea0200000019"), "sort" : 4 },
        { "_id" : ObjectId("514825fa2a26ea0200000013"), "sort" : 5 },
        { "_id" : ObjectId("5149dccb5fc6390200000013"), "sort" : 6 },
        { "_id" : ObjectId("514825fa2a26ea0200000028"), "sort" : 7 },
        { "_id" : ObjectId("52f15e421c67d1a4859d1eee"), "sort" : 8 },
        { "_id" : ObjectId("5181d0a966a6f999a465eb85"), "sort" : 9 },
        { "_id" : ObjectId("514825fa2a26ea020000001a"), "sort" : 10 },
        { "_id" : ObjectId("5181d0a966a6f999a465eb66"), "sort" : 11 },
        { "_id" : ObjectId("514a3f40bf82130200000031"), "sort" : 12 },
        { "_id" : ObjectId("514a3f2ebf82130200000030"), "sort" : 13 },
        { "_id" : ObjectId("5181d0a966a6f999a465eb34"), "sort" : 14 },
        { "_id" : ObjectId("5227a21366a6f999a465f765"), "sort" : 15 },
        { "_id" : ObjectId("5181d0a966a6f999a465eb7f"), "sort" : 16 },
        { "_id" : ObjectId("5181d0a966a6f999a465ecaa"), "sort" : 17 },
        { "_id" : ObjectId("533f1d061c67d1a4859d2bcf"), "sort" : 18 },
        { "_id" : ObjectId("5181d0ab66a6f999a465eefb"), "sort" : 19 },
        { "_id" : ObjectId("5181d0ad66a6f999a465f249"), "sort" : 20 },
        { "_id" : ObjectId("5181d0ac66a6f999a465f100"), "sort" : 21 },
        { "_id" : ObjectId("5181d0ab66a6f999a465efe6"), "sort" : 22 },
        { "_id" : ObjectId("5181d0a966a6f999a465eb61"), "sort" : 23 },
        { "_id" : ObjectId("5181d0ab66a6f999a465ef74"), "sort" : 24 },
        { "_id" : ObjectId("5181d0a966a6f999a465ec9f"), "sort" : 25 },
        { "_id" : ObjectId("514a3e17bf8213020000002f"), "sort" : 26 },
        { "_id" : ObjectId("5181d0ab66a6f999a465efdb"), "sort" : 27 },
        { "_id" : ObjectId("5289276e66a6f999a465fba6"), "sort" : 28 },
        { "_id" : ObjectId("5181d0aa66a6f999a465ede2"), "sort" : 29 },
        { "_id" : ObjectId("5181d0aa66a6f999a465edfe"), "sort" : 30 },
        { "_id" : ObjectId("514825fa2a26ea0200000007"), "sort" : 31 }
    ],
    "userId" : ObjectId("53e52ceb8f8c80299bcc402c"),
  }
}
