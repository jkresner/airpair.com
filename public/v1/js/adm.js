...
}]).run(['$rootScope', 'SessionService', 'AdmDataService', function($rootScope, SessionService, AdmDataService) {}]).directive('apPostListItem', ['$parse', function($parse) {
  return {
...
}]).run(['$rootScope', 'SessionService', 'AdmDataService', function($rootScope, SessionService, AdmDataService) {}]).controller('UsersCtrl', ['$scope', 'AdmDataService', function($scope, AdmDataService) {
  $scope.role = "editor";
